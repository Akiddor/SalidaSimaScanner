    ...
    <body>
        ...
        <main>
            ...
            <?php if (isset($message) && isset($messageType)): ?>
                <div id="notification" class="notification <?php echo htmlspecialchars($messageType); ?> show">
                                                            ...
                                                            while ($pallet = mysqli_fetch_assoc($palletsResult)):
                                                                ...
                                                                <div class="accordion-item custom-accordion-item"
                                                                    ...
                                                                    <div class="accordion-header custom-accordion-header">
                                                                        ...
                                                                        <button class="btn-select-pallet"
                                                                            data-pallet-id="<?php echo $pallet['id']; ?>">
                                                                                ...
                                                                                if ($itemsResult && mysqli_num_rows($itemsResult) > 0):
                                                                                    while ($item = mysqli_fetch_assoc($itemsResult)):
                                                                                        ...
                                                                                        <tr data-item-id="<?php echo $item['id']; ?>">
                                                                                            <td class="custom-td">
                                                                                                <?php echo htmlspecialchars($item['numero_parte']); ?></td>
                                                                                            <td class="custom-td">
                                                                                                <?php echo htmlspecialchars($item['nifco_numero']); ?></td>
                                                                                            <td class="custom-td">
                                                                                                <?php echo htmlspecialchars($item['serial_number']); ?></td>
                                                                                            <td class="custom-td">
